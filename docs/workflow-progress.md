...
| Phase 2 | MVP metier        | In progress | 45%        | Auth, profils, catalogue, categories, cart, orders et chat sont deja poses partiellement |
...
| 6     | Chat produit/vendeur                          | In progress | Backend conversations actif, persistance locale, outbox, realtime et statuts delivered/read deja branches | Stabiliser media, retries et parcours de validation bout en bout   |
...
| P1       | Valider le chat de bout en bout en conditions reelles       | Le backend et le realtime sont la, il faut maintenant verrouiller la fiabilite produit |
| P2       | Brancher vraiment likes, comments, follow                   | Fait partie du coeur social du MVP                                                     |
| P2       | Stabiliser TLS/HTTPS et la connectivite mobile pour la prod | Evite les regressions reseau sur appareil reel et sur le realtime                      |
